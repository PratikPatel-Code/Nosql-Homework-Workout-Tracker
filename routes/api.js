// Standard requires, had help from Malcolm and others in group study. Used mongoose-cast-aggregation
// Had alot of trouble with this and needed their help to get it working.
...
router.get("/api/workouts/range", (req, res) => {
  ...
  Workout.aggregate([
    { $match: { day: { $gte: beginningDate, $lte: endingDate } } },
  ])
    .project({
      day: 1,
      "exercises.duration": 1,
